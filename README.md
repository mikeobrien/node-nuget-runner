...
[![npm version](http://img.shields.io/npm/v/nuget-runner.svg)](https://npmjs.org/package/nuget-runner) [![build status](http://img.shields.io/travis/mikeobrien/node-nuget-runner.svg)](https://travis-ci.org/mikeobrien/node-nuget-runner)
